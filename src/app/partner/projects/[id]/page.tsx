...
export default function PartnerProjectDetailsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-20">
      {/* Breadcrumbs */}
      <button onClick={() => router.push('/partner/dashboard')} className="text-slate-500 hover:text-white text-sm font-bold mb-8 flex items-center gap-2 transition-colors cursor-pointer bg-transparent border-none outline-none">
      ...
      <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-4">
              {deliverables.map((item) => (
                <div key={item.id} className="bg-white/5 border border-white/10 rounded-3xl p-6 flex items-center justify-between group hover:bg-white/[0.08] transition-all">
                  ...
                  {item.submission_url && (
                    <a href={item.submission_url} target="_blank" rel="noreferrer" className="p-3 bg-white/5 hover:bg-white/10 rounded-xl transition-all border border-white/5">
          ...
          <section className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="px-8 py-3 bg-blue-600 hover:bg-blue-500 rounded-xl font-bold text-sm shadow-lg shadow-blue-600/20 transition-all text-white cursor-pointer">
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-indigo-900/40 to-blue-900/40 border border-white/10 rounded-[2.5rem] p-8 shadow-2xl">
            ...
            <button className="w-full py-4 bg-white text-slate-950 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-slate-200 transition-all cursor-pointer">
              Book Meeting
            </button>
          </div>
