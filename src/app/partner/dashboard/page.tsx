...
export default function PartnerDashboardPage() {
  ...
  const stats = [
    { label: 'Sponsored Projects', value: projects.length, icon: <Briefcase className="w-5 h-5 text-blue-400" /> },
            ...
            >
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium">Student Team: Team Alpha</p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="p-6 bg-white/5 border border-white/10 rounded-[2rem]">
                ...
                <button className="w-full py-2 bg-white/5 hover:bg-white/10 rounded-xl text-xs font-bold transition-all border border-white/10 text-white cursor-pointer">
                  Join Call
                </button>
              </div>
            ))}
