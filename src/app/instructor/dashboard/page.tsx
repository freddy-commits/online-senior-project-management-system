    ...
    <div className="max-w-7xl mx-auto pb-20">
      ...
      {pendingApprovals.length > 0 && (
        <div className="mb-10 p-6 bg-yellow-500/10 border border-yellow-500/20 rounded-[2rem] flex items-center justify-between">
          ...
          <button onClick={() => router.push('/instructor/vetting')} className="px-6 py-2 bg-yellow-500 text-black font-bold rounded-xl text-sm hover:bg-yellow-400 transition-all cursor-pointer">
            Review Now
          </button>
        </div>
      )}
