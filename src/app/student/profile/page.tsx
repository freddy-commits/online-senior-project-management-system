...
import AcademicDetailsSection from '@/components/settings/AcademicDetailsSection'
    ...
    <div className="max-w-4xl mx-auto pb-20 p-4 md:p-8 relative">
      ...
      <div className="mb-10 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Manage your profile details, academic credentials, and security preferences.</p>
        </div>
        <Link 
      ...
      <div className="space-y-8">
        ...
        <AcademicDetailsSection initialData={profile} onSave={async () => true} />
