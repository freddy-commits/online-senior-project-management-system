...
export default function PartnerLayoutClient({ children, initialUserName }: PartnerLayoutClientProps) {
    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex flex-col font-sans">
      ...
      <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 px-8 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <Link href="/partner/profile" className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
